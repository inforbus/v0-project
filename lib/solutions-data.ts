...
结果：Agent 生成数据驱动的分析结论，支撑决策。` },
  ...
  },
  {
    ...
    heroImage: "/images/solutions/ai-agent.png",
    overview: `在数字化转型与信创改造的关键期，企业IT系统日益复杂，传统的"救火式"运维不仅成本高昂，更时刻威胁着业务的稳定与收入。我们的智能运维解决方案，致力于彻底改变这一现状。通过构建全景感知、数据驱动、主动智能的新一代运维体系，为您提供从底层基础设施、云平台到上层核心业务应用的一体化监控、智能分析与自动化处置能力。它能提前预警故障、分钟级定位根因，将计划外业务中断降低80%以上，直接守护您的收入生命线。同时，方案深度兼容信创生态，帮助团队从重复性劳动中解放，聚焦于高价值创新，推动运维从"成本中心"真正转变为业务增长的驱动引擎。`,
    highlights: [
