...
结果：Agent 生成数据驱动的分析结论，支撑决策。` },
  ...
  },
  {
    ...
    highlights: [
      { icon: "deploy", title: "双活保畅", desc: `区别于传统的"冷备"模式，本方案实现真正的双活架构。两侧集群均可同时提供读写服务，无需���待数据同步完成，无需���时启动服务。当故障发生时，业务流量可直接切换至健康集群，整个过程近乎无感知，RTO趋近于零，保障业务连续性。` },
