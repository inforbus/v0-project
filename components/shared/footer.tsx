  ...
  return (
    <footer className="bg-muted pb-4 pt-8 3xl:pb-6 3xl:pt-10">
      <div className="mx-auto max-w-6xl px-4 lg:px-8 2xl:max-w-[1100px] 3xl:max-w-[1400px]">
        <div className="flex flex-col gap-10 lg:flex-row lg:gap-6 lg:overflow-x-auto lg:-mx-4 lg:px-4">
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5 lg:gap-1 flex-shrink-0 w-full lg:w-auto">
          ...
          <div className="border-t border-border pt-6 lg:border-l lg:border-t-0 lg:pl-6 lg:pt-0 flex-shrink-0 w-full lg:w-auto">
