  ...
  return (
    <section className="relative overflow-hidden bg-white px-4 py-12 md:py-16 lg:px-0 lg:py-[80px] lg:pt-[80px] 3xl:py-[120px] 3xl:pt-[121px]">
      <div className="pointer-events-none absolute inset-0 h-full w-full opacity-50">
        <Image src="/images/section-bg-wave.png" alt="" fill className="object-cover" style={{ mixBlendMode: "soft-light" }} loading="eager" />
      </div>
          ...
          <ScrollReveal delay={100}>
            <div className="w-full lg:w-[440px] lg:flex-shrink-0 lg:pt-[40px] 3xl:w-[592px] 3xl:pt-[61px]">
              <p className="text-sm leading-[200%] text-[#242222] md:text-base lg:text-[16px] lg:leading-[200%] 3xl:text-[22px]">
                中创应用服务器软件（简称：InforSuite AS）是一款全面符合Jakarta EE 10/9.1/9/8及Java EE 8/7/6国际规范的企业级应用服务器中间件产品，为应用系统提供安全可靠、稳定高效的运行环境及开发、部署、监控、运维等全生命周期管理支撑。产品在党政军及能源、金融、交通、电信等关键信息基础设施行业领域中，规模化替代国外及开源产品，促进客户网络信息安全提升与数字化转型。
              </p>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={300}>
            <div className="w-full lg:w-[500px] lg:flex-shrink-0 3xl:w-[674px]">
              ...
              >
                ...
                >
                  <Image src="/images/inforsuite-architecture.png" alt="InforSuite AS 架构图" width={489} height={339} className="h-auto w-[79%] object-contain" />
                </div>
              </div>
            </div>
          </ScrollReveal>
