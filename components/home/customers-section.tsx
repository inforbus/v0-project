...
const customerRows = [
  [
    { name: "国家开发银行", logo: "/images/customers/ndb.png" },
    { name: "平安科技", logo: "/images/customers/pingan-tech.webp" },
    { name: "国家开发投资集团有限公司", logo: "/images/customers/cidg.png" },
    { name: "东风汽车集团有限公司", logo: "/images/customers/dongfeng.png" },
    { name: "永诚保险", logo: "/images/customers/yongcheng.png" },
    ...
    { name: "招商银行", logo: "/images/customers/cmbchina.png" },
    { name: "招商局集团有限公司", logo: "/images/customers/coc.png" },
  ],
  [
    { name: "浪潮", logo: "/images/customers/inspur.png" },
    { name: "湖南银行（华融湘江银行更名）", logo: "/images/customers/hunan-bank.png" },
    { name: "国投财务有限公司", logo: "/images/customers/guotou-finance.png" },
    { name: "广州农商行", logo: "/images/customers/gzrcb.png" },
    { name: "广发银行", logo: "/images/customers/cib.png" },
    { name: "兴业银行", logo: "/images/customers/cib-xingye.png" },
    { name: "中国兵器工业集团有限公司", logo: "/images/customers/norinco.jpg" },
    { name: "齐鲁银行", logo: "/images/customers/qilu-bank.png" },
    { name: "国家电投", logo: "/images/customers/spic.png" },
    { name: "中国信息通信科技集团有限公司", logo: "/images/customers/chitc.png" },
    { name: "中国电气装备集团有限公司", logo: "/images/customers/ceeg.png" },
    { name: "中国铝业集团有限公司", logo: "/images/customers/chinalco.png" },
    { name: "中国葛洲坝集团有限公司", logo: "/images/customers/ctgc.png" },
    { name: "中国航空油料集团有限公司", logo: "/images/customers/caog.png" },
    { name: "中泰证券", logo: "/images/customers/citic-securities.png" },
    { name: "中国人民银行", logo: "/images/customers/pbc.webp" },
    { name: "中国农业银行", logo: "/images/customers/abc.png" },
    { name: "中国民生银行", logo: "/images/customers/cmbc.png" },
    { name: "中国银行", logo: "/images/customers/boc.png" },
    { name: "中国中车集团有限公司", logo: "/images/customers/crc.png" },
    { name: "中国电建", logo: "/images/customers/powerchina.jpg" },
    { name: "中国太平保险", logo: "/images/customers/cptpp.png" },
