    ...
    <>
      ...
      <div className="relative flex h-[700px] w-full flex-col overflow-hidden">
        ...
        <div
          className="absolute inset-0 z-10 flex items-center transition-all duration-[1500ms] ease-in-out"
          style={{
            opacity: mounted && currentSlide === 1 ? 1 : mounted && 1 === 1 ? 0 : 0,
        ...
        <div
          className="absolute inset-0 z-10 flex items-center transition-all duration-[1500ms] ease-in-out"
          style={{
            opacity: mounted && currentSlide === 2 ? 1 : mounted && 2 === 1 ? 0 : 0,
        ...
        <div
          className="absolute inset-0 z-10 flex items-center transition-all duration-[1500ms] ease-in-out"
          style={{
            opacity: mounted && currentSlide === 3 ? 1 : mounted && 3 === 1 ? 0 : 0,
            transform: mounted && currentSlide === 3 ? "translateY(0)" : "translateY(20px)",
            pointerEvents: mounted && currentSlide === 3 ? "auto" : "none",
          }}
          suppressHydrationWarning
        >
          <div className="mx-auto w-full max-w-6xl px-4 lg:px-8 2xl:max-w-[1100px] 3xl:max-w-[1400px]">
