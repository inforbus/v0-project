      ...
      <div className="mx-auto max-w-6xl px-4 lg:px-8">
        ...
        <div className="mb-12 lg:mb-16">
          ...
          <div className="space-y-4 text-base leading-relaxed text-foreground/80 lg:text-lg">
            <p>
              中创软件商用中间件股份有限公司（以下简称"中创中间件"）成立于2002年，是国内领先的基础软件产品与服务提供商，是国家"核高基"科技重大专项支持单位，拥有CMMI DEV 5 级资质和 ISO9001 质量体系认证证书，为国际Jakarta EE 工作组企业级会员单位。公司产品曾获得工信部颁布的"国防科学技术进步二等奖"、山东省人民政府颁布的"山东省科学技术进步二等奖"、中国软件行业协会颁布的中国"自主可靠企业核心软件品牌"、"年度创新软件产品"、 "十佳创新软件产品"等多个奖项。
            </p>
            <p>
