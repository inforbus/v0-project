...
export function WSOverviewSection() {
  return (
          ...
          <ScrollReveal delay={100}>
            <div className="w-full lg:w-[440px] lg:flex-shrink-0 lg:pt-[40px] 3xl:w-[592px] 3xl:pt-[61px]">
              <p className="text-sm leading-[200%] text-[#242222] md:text-base lg:text-[16px] lg:leading-[200%] 3xl:text-[22px]">
                中创防篡改软件是专注于网站安全的产品。保护用户网站内容安全，防止文件被恶意篡改，确保网站的正确性、完整性和权威性。中创防篡改软件是保障网站安全、维护企业形象的关键产品。产品已广泛应用在政府、金融、通讯、教育、企业等领域；用心20年专注防篡改，已成为高端客户信赖的品牌
              </p>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={300}>
            <div className="w-full lg:w-[500px] lg:flex-shrink-0 3xl:w-[674px]">
              ...
              >
                ...
                >
                  <Image
                    src="/images/ws-architecture.png"
                    alt="中创防篡改软件"
                    width={489}
                    height={339}
