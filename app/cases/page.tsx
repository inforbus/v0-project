...
export default function CasesPage() {
  return (
    <main className="min-h-screen">
      {/* Hero Banner */}
      <section className="relative overflow-hidden bg-gradient-to-b from-primary/5 to-background py-14 md:py-20 lg:py-[80px] 3xl:py-[100px]">
        <div className="relative z-10 mx-auto max-w-6xl px-4 lg:px-8 2xl:max-w-[1100px] 3xl:max-w-[1400px]">
          <ScrollReveal>
            <div className="text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-base text-muted-foreground md:mt-6 md:text-lg 3xl:text-xl">
                前沿技术与品质服务，助力企业数智化转型
              </p>
            </div>
          </ScrollReveal>
      ...
      {/* Cases Grid */}
      <section className="bg-background py-14 md:py-20 lg:py-[80px] 3xl:py-[100px]">
