        ...
        <div className="absolute inset-0 flex items-end">
          <div className="mx-auto w-full max-w-6xl px-4 pb-10 lg:px-8 2xl:max-w-[1100px] 3xl:max-w-[1400px] 3xl:pb-14">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="inline-flex items-center gap-1.5 rounded-full bg-white/15 px-3 py-1 text-xs text-black backdrop-blur-sm 3xl:px-4 3xl:py-1.5 3xl:text-sm">
